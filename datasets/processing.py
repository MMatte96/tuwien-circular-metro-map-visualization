...
[clusters, cluster_definitions] = create_hierarchical_clustering(data_without_low_freq_fos)
# assign clusters to publications
assign_clusters_to_publications(data_without_low_freq_fos, clusters, cluster_definitions)
